...
class myTestOrderByPriceLowToHigh(unittest.TestCase):

    def testOrderByPriceLowToHigh(self):
...
#Seleccionando que clasifique por precio de bajo a alto.
        driver.find_element_by_xpath('//*[@id="header_container"]/div[2]/div[2]/span/select/option[3]').click()
        time.sleep(5)

# Realizar Scroll en la pagina para ver el precio de orden de bajo hacia alto de productos
